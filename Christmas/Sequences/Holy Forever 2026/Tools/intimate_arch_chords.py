...
from Christmas/Sequences/Holy Forever 2026/Timing Templates/Holy Forever Piano Chords.xsq — audio-detected big
...
Run: python3 Christmas/Sequences/Holy Forever 2026/Tools/intimate_arch_chords.py [--dry-run]
"""
import sys
...
def piano_chords():
    ...
    try:
        ...
        raise SystemExit(
            ...
            f'Christmas/Sequences/Holy Forever 2026/Timing Templates/Holy Forever Piano Chords.xsq first ({e})')
    out = []
    for eid in ids:
