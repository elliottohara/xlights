...
Run:
    python3 Christmas/Sequences/Holy Forever 2026/Tools/intimate_mini_tree_piano.py [--dry-run]
    python3 Christmas/Sequences/Holy Forever 2026/Tools/intimate_mini_tree_piano.py --clear-only
"""
import sys
